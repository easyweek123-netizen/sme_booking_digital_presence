...
@ToolHandler({
  ...
  description:
    'Call this when user wants to see their booking page in preview tab.'+ 
    'You can use this tool to show user how their booking page look after updating business profile or services.',
})
@Injectable()
