...
export class RemovePhoneFields1733370005000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "bookings" DROP COLUMN IF EXISTS "customerPhone"`,
    );
    ...
    await queryRunner.query(
      `DELETE FROM "customers" WHERE "firebaseUid" IS NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "customers" ALTER COLUMN "firebaseUid" SET NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "customers" ALTER COLUMN "firebaseUid" DROP NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "bookings" ADD COLUMN "customerPhone" VARCHAR(20)`,
    );
  }
}
